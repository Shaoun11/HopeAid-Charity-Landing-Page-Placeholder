...
const Testimonial = () => {
    return (
        ...
        <div className='max-w-7xl mx-auto pt-[60px] pb-[60px]'>
            ...
            <div className='md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-6 lg:ml-0 ml-6 lg:mr-0 mr-6'>
                 {/* HopeAid first testimonial card */}
                <div className='bg-[#FFF] shadow-md rounded-2xl mt-12'>
                    <div className='p-6'>
                        ...
                        <div className='flex gap-3 ml-4 mt-4'>
                            <Image className='w-[48px] mb-4 h-[48px] rounded-full object-cover' src={testimonial_image} ></Image>
                ...
                {/* HopeAid second testimonial card */}
                <div className='bg-[#FFF] lg:block md:block hidden shadow-md rounded-2xl mt-12'>
                    <div className='p-6'>
                        <svg className='absolute -mt-[50px] ml-2' width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="24" cy="24" r="24" fill="#068278" />
                            <path d="M16 30.056V25.688C16 24.056 16.288 22.552 16.864 21.176C17.44 19.8 18.416 18.408 19.792 17L22.288 18.968C21.488 19.768 20.88 20.52 20.464 21.224C20.048 21.928 19.776 22.648 19.648 23.384H22.72V30.056H16ZM25.36 30.056V25.688C25.36 24.056 25.648 22.552 26.224 21.176C26.8 19.8 27.776 18.408 29.152 17L31.648 18.968C30.848 19.768 30.24 20.52 29.824 21.224C29.408 21.928 29.136 22.648 29.008 23.384H32.08V30.056H25.36Z" fill="white" />
                ...
                {/* HopeAid third testimonial card */}
                <div className='bg-[#FFF] lg:block hidden shadow-md rounded-2xl mt-12'>
                    <div className='p-6'>
                        <svg className='absolute -mt-[50px] ml-2' width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="24" cy="24" r="24" fill="#068278" />
                            <path d="M16 30.056V25.688C16 24.056 16.288 22.552 16.864 21.176C17.44 19.8 18.416 18.408 19.792 17L22.288 18.968C21.488 19.768 20.88 20.52 20.464 21.224C20.048 21.928 19.776 22.648 19.648 23.384H22.72V30.056H16ZM25.36 30.056V25.688C25.36 24.056 25.648 22.552 26.224 21.176C26.8 19.8 27.776 18.408 29.152 17L31.648 18.968C30.848 19.768 30.24 20.52 29.824 21.224C29.408 21.928 29.136 22.648 29.008 23.384H32.08V30.056H25.36Z" fill="white" />
            ...
            <div className='flex justify-center mt-12'>
                <svg xmlns="http://www.w3.org/2000/svg" width="72" height="8" viewBox="0 0 72 8" fill="none">
                    <circle cx="4" cy="4" r="4" fill="#69B99D" />
                    <circle cx="20" cy="4" r="4" fill="#E9ECEC" />
                    <circle cx="36" cy="4" r="4" fill="#E9ECEC" />
                    <circle cx="52" cy="4" r="4" fill="#E9ECEC" />
                    <circle cx="68" cy="4" r="4" fill="#E9ECEC" />
                </svg>
            </div>
        </div>
