...
const Hero = () => {
    return (
        ...
        <div id='/' className='bg-[#FEF9F6] lg:min-h-[calc(100vh-78px)]'>
            <div className='max-w-7xl md:flex lg:gap-14 lg:pt-16 pt-11 lg:ml-32 md:ml-0 ml-0 mx-auto '>
                ...
                <div>
                    <div className='lg:mr-0 lg:ml-8 md:ml-0 ml-0 lg:-mt-8 md:mt-0 mt-0 md:mr-8 mr-0'>
                        ...
                        <div className='lg:-mt-[350px] md:mt-[100px] md:ml-[90px] -mt-[50px] lg:ml-2 ml-[90px] lg:pb-12 md:pb-5 pb-5 '>
                            ...
                            <Image src={hero_main_image} className='lg:w-[424px] lg:h-[424px] w-[267px] h-[267px] object-cover rounded-full lg:-mt-[432px] -mt-[271px] ml-1 lg:ml-[8px] '></Image>
                        </div>
                    </div>
                </div>
            </div>
